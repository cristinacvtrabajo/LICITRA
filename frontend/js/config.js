...
// Toda comunicación con Supabase y Groq pasa por el backend (/api/...).
// El frontend no necesita ni debe tener ninguna clave de acceso.
...
// IMPORTANTE: Debe tener TODAS las claves de COL_MAP en el MISMO ORDEN
const KEY_TO_COL = {
 id: 'identificador',
 ...
 fechaAcuerdo: 'fecha_acuerdo_licitacion_lote',
 ...
 fechaFormalizacion: 'fecha_formalizacion_contrato',
 fechaVigencia: 'fecha_entrada_vigor',
